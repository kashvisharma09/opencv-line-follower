...
## Demo 
<p align="center">
  <img src="line_follower_demo.png" alt="Line follower detecting a line and outputting FORWARD direction">
</p>
<p align="center">
  <em>The system detecting the line's contour (blue outline) and centroid (green dot), with the computed steering direction shown in the top-left corner.</em>
</p>
